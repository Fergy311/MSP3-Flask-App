...
## [MSP Repsoitory ] (https://github.com/Fergy311/MSP3-Flask-App)
...
- I used green and white as the colour scheme for the website. 

- I used a dark green for the main background colour and a light green for the text. 

- The green was chosen as it was a colour that could be used in a variety of different ways, it was also a colour that I liked and could be used to make the website appear to promote health and promote the website as a place to learn and cook and eat healthy. 

- I used [coolors.co](https://coolors.co) to decide and find the correct hexcode for the shades used. 
...
- All imagary on the site is uploaded personally from various different sources while implementing the recipes 
